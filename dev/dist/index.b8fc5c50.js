...
})({"dPUkO":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ad0b2b42b8fc5c50";
...
var _dateTimeViewJs = require("./view/dateTimeView.js");
var _dateTimeViewJsDefault = parcelHelpers.interopDefault(_dateTimeViewJs);
var _buttonsViewJs = require("./view/buttonsView.js");
var _buttonsViewJsDefault = parcelHelpers.interopDefault(_buttonsViewJs);
var _addButtonViewJs = require("./view/addButtonView.js");
var _addButtonViewJsDefault = parcelHelpers.interopDefault(_addButtonViewJs);
var _todosViewJs = require("./view/todosView.js");
var _todosViewJsDefault = parcelHelpers.interopDefault(_todosViewJs);
var _editedViewJs = require("./view/editedView.js");
var _editedViewJsDefault = parcelHelpers.interopDefault(_editedViewJs);
var _regeneratorRuntime = require("regenerator-runtime");
// Get current ID
const controlID = function(currID) {
    _modelJs.createCurrentID(currID);
};
// Loads LocalStorage data
const controlRender = function() {
    if (_modelJs.state.todoList.length === 0) return;
    // TODO find a way to use only render
    // todosView.render(model.state.todoList);
    _todosViewJsDefault.default.renderTodoStorage(_modelJs.state.todoList);
};
// TODO Make rendering smoother
// Add Button
const controlAdd = function() {
    const todoData = _addButtonViewJsDefault.default.getTodo();
    if (!todoData) return;
    // Pushes data to state
    _modelJs.createTodos(todoData);
    // Renders todo
    _todosViewJsDefault.default.render(_modelJs.state.renderTodo);
};
...
const controlEditSubmit = function() {
    ...
    _modelJs.editTodos(_editedViewJsDefault.default.getEditedTodo());
    // Render edited data to view
    _editedViewJsDefault.default.renderEdit(_modelJs.state.editedTodo);
};
// Make delete smoother
// Delete in Array (PubSub Model)
const controlDelete = function(id) {
    _modelJs.deleteTodos(id);
};
const init = function() {
    _dateTimeViewJsDefault.default.renderDateTime();
    _todosViewJsDefault.default.getCurrentID(controlID);
    _todosViewJsDefault.default.loadTodos(controlRender);
    _addButtonViewJsDefault.default.toggleForm();
    _buttonsViewJsDefault.default.checkStrike();
    _buttonsViewJsDefault.default.toggleEdit();
    _editedViewJsDefault.default.addHandlerEditSubmit(controlEditSubmit);
    _addButtonViewJsDefault.default.addHandlerSubmit(controlAdd);
    _buttonsViewJsDefault.default.addHandlerDelete(controlDelete);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./view/dateTimeView.js":"3oBXs","./view/buttonsView.js":"cR0CN","./view/addButtonView.js":"hm35p","./view/todosView.js":"gmmtS","./view/editedView.js":"lK7l2","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
parcelHelpers.export(exports, "createCurrentID", ()=>createCurrentID
);
parcelHelpers.export(exports, "createTodos", ()=>createTodos
);
parcelHelpers.export(exports, "editTodos", ()=>editTodos
);
parcelHelpers.export(exports, "deleteTodos", ()=>deleteTodos
);
...
const state = {
    ...
    editedTodo: {},
    todoList: [],
    currentID: _configJs.DEFAULT_ID
};
// Add todos
...
const createCurrentID = function(currID) {
    if (currID) // CurrID will set if there is an child element on the hardcoded HTML Todos
    return state.currentID = currID;
    if (state.todoList.length === 0) return;
    const maxID = state.todoList.map((todoData)=>todoData.id
    ).reduce((acc, id)=>{
...
const editTodos = function(editData) {
    const editingData = state.todoList.find((data)=>data.id === +editData.editedID
    );
...
const deleteTodos = function(id) {
    const indexToDelete = state.todoList.findIndex((todoData)=>todoData.id === +id
    );
...
},{}],"3oBXs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class DateTimeView {
    ...
    _dateClock() {
        ...
        const date = new Intl.DateTimeFormat(navLocale, optionsDate).format(new Date());
        const time = new Intl.DateTimeFormat(navLocale, optionsTime).format(new Date());
...
exports.default = new DateTimeView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cR0CN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class Buttons extends _viewJsDefault.default {
    ...
    toggleEdit() {
        this._parentEl.addEventListener('click', (e)=>{
            ...
            if (!editBTN) return;
            const clickContainer = editBTN.parentElement.previousElementSibling.querySelector('.edit-form__container');
            const clickContent = editBTN.parentElement.previousElementSibling.querySelector('.todo__content');
            const clickInput = editBTN.parentElement.previousElementSibling.querySelector('.edit-text');
            ...
            clickInput.value = clickContent.textContent.replace(/[\n\r]+|[\s]{2,}/g, ' ').trim();
        });
    }
...
},{"./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gAkKI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
'use strict';
class View {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hm35p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Add the ID number on HTML
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class AddButtonView extends _viewJsDefault.default {
...
exports.default = new AddButtonView();

},{"./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gmmtS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class TodosView extends _viewJsDefault.default {
    _parentEl = document.querySelector('.todos');
    _todosArr;
    // Push the current Id number to model to store in state
    getCurrentID(handler) {
        window.addEventListener('load', this._getCurrentIDMethod.bind(this, handler));
    }
    loadTodos(handler) {
    ...
    _getCurrentIDMethod(handler) {
        const todosArray = [
            ...this._parentEl.children
        ];
        const idArr = [];
        if (todosArray.length === 0) return handler();
    ...
    _generateMarkUpArr() {
        return this._data.map((todoData)=>_previewViewJsDefault.default.render(todoData, false)
        ).join('');
    }
}
exports.default = new TodosView();

},{"./View.js":"gAkKI","./previewView.js":"8eAfY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8eAfY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lK7l2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class EditedView extends _viewJsDefault.default {
    _parentEl = document.querySelector('.todos');
    _editedData;
    _editedID;
    _editedEl;
...
exports.default = new EditedView();

},{"./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}]},["dPUkO","aenu9"], "aenu9", "parcelRequire0770")

//# sourceMappingURL=index.b8fc5c50.js.map
